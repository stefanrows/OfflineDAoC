...
namespace DOL.GS
{
	...
	internal static class AllRealmsTeleportFallbacks
	{
		...
		private static readonly Dictionary<string, (string TeleportID, int RegionID, int X, int Y, int Z, int Heading)> Routes = new(StringComparer.OrdinalIgnoreCase)
		{
			...
			["1:Agramon"] = ("Agramon", 163, 546877, 480723, 9272, 3471),
			["1:Forest Sauvage"] = ("Forest Sauvage", 163, 652700, 617189, 9560, 2815),
			...
			["2:Agramon"] = ("Agramon", 163, 525422, 439601, 9253, 1662),
			["2:Uppland"] = ("Uppland", 163, 651611, 315012, 9432, 1934),
			...
			["3:Agramon"] = ("Agramon", 163, 505864, 478304, 9135, 3946),
			["3:Cruachan Gorge"] = ("Cruachan Gorge", 163, 395474, 618665, 9816, 2616),
